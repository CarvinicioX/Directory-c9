...
class ColoniesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create colony" do
    assert_difference('Colony.count') do
      post colonies_url, params: { colony: { description: @colony.description, name: @colony.name, polling_station_id: @colony.polling_station_id } }
    end
  ...
  test "should update colony" do
    patch colony_url(@colony), params: { colony: { description: @colony.description, name: @colony.name, polling_station_id: @colony.polling_station_id } }
