...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sector" do
    assert_difference('Sector.count') do
      post sectors_url, params: { sector: { municipality_id: @sector.municipality_id, name: @sector.name, num_sector: @sector.num_sector } }
    end
  ...
  test "should update sector" do
    patch sector_url(@sector), params: { sector: { municipality_id: @sector.municipality_id, name: @sector.name, num_sector: @sector.num_sector } }
