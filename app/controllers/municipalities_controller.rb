class MunicipalitiesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to municipalities_path(:department => @municipality.department), notice: 'Municipality was successfully destroyed.' }
  ...
  private
    ...
    def municipality_params
      params.require(:municipality).permit(:department_id, :num_minicip, :name)
    end
end
